...
type ParsingError struct {
	...
	IsApplicationDataMacError             bool
	ServerSessionTicketMissingError       bool
}
...
func (pe *ParsingError) Error() string {
	...
	if pe.IsApplicationDataMacError {
		return "ApplicationData Mac Error!"
	}
	if pe.ServerSessionTicketMissingError {
...
func ServerSessionTicketMissingError() error {
	return &ParsingError{ServerSessionTicketMissingError: true}
}
...
func ApplicationDataMacError() error {
	return &ParsingError{IsApplicationDataMacError: true}
}
